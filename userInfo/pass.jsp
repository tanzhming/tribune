...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath }/user_updatePwd">
      <div class="form-group">
        ...
        <div class="field">
          <label style="line-height:33px;">
          	<input type="hidden" name="id" value="${userInfo.id }">  <!-- 隐藏域：用户id -->
          	<input type="hidden" name="loginName" value="${userInfo.loginName }">  <!-- 隐藏域：用户登录名 -->
          </label>
        </div>
      </div>      
      <div class="form-group">
