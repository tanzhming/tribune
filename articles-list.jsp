...
<!doctype html>
        ...
        <body>
                ...
                <div class="page-container">
					...
					<c:forEach var="tp" items="${listArticles }" varStatus="vs">
					...
					<section class="widget">
						...
						<ul>
							<c:forEach var="ty" items="${listTypes }" varStatus="vs">
								<li><a href="${pageContext.request.contextPath }/topic_view_ByType?id=${ty.id }&currentPage=1" title="Lorem ipsum dolor sit amet,">${ty.typeName
										}</a></li>
							</c:forEach>
						</ul>
					</section>
				...
				<div id="pagination" style="font-size: 33px;">
						当前&nbsp;&nbsp;${currentPage }/${totalPage }&nbsp;&nbsp;页 <a
							href="${pageContext.request.contextPath }/topic_view_articles?currentPage=1">
							首页 </a> &nbsp;&nbsp;
						<c:if test="${currentPage!=1 }">
							<a
								href="${pageContext.request.contextPath }/topic_view_articles?currentPage=${currentPage-1 }">
								上一页 </a>
						</c:if>
						&nbsp;&nbsp;
						...
						<c:if test="${currentPage!=totalPage }">
							<a
								href="${pageContext.request.contextPath }/topic_view_articles?currentPage=${totalPage }">
								末页 </a>
						</c:if>
						<c:if test="${currentPage==totalPage }">
							<a>末页</a>
